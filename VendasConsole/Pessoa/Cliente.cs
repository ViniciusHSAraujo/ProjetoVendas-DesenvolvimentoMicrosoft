...
namespace VendasConsole {
    /**
     * Classe que representa o Cliente, com Nome, CPF e Data de Cadastro.
     * Utiliza o método de validação de CPF disponível no diretório Utils.
     * 
     * @Author: ViniciusHSAraujo
     */
